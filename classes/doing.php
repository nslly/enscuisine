    ...
    class Doing extends Dbh {
        ...
        public function edit_reservation($id) {
            ...
            if(isset($_POST['reserve_update'])){
                ...
                if(isset($_POST['table'])) {
                    $reserve_table_update = $_POST['table'];
                } else {
                    echo "";
                }
        ...
        // Displaying the foods to make it not repetitive, pamapaikli pa
        public function display_foods($img_path,$img_name,$img_price,$hidden_name,$hidden_price,$hidden_img,$sales) {
            $element = "
                <div class='grid_food'>
                    <div class='grid_food_img'>
                        <img src='images/foods/$img_path' alt='Wala pa'>
                        <p class='food_sale'>$sales off</p>
                    </div>
                    <div class='foods_name_price'>
                        <p>$img_name</p>
                        <p>$img_price P</p>               
                    </div>
                    <div class='foods_button_grid'>
                        ...
                        <input type='number' name='add_subtract'  value='1' min='1'>
                        <button name='add_to_foods' class='add_to_cart'>Add</button>
                    </div>
                </div>
            ";
